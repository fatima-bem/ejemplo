...
<body class="bg-dark">
    ...
    <div class="container">
        <div class="row" style="justify-content: center; ">
            <div class="col-sm-6 col-md-6" style="margin-top:2%;">
                <h2 class="text-white">Registro Datos Personales</h2>
                <h5 class="text-white">Todos los documentos deben ser en formato PDF </h5>
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal">
                    Usuarios
                </button>
                <form class="" id="formPersonal" enctype="multipart/form-data">
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="ine" class="form-label text-white">Selecciona INE</label>
                        <input class="form-control" name="ine" type="file" id="ine" required>
                    </div>
                    <div class="mb-3">
                        <label for="curp" class="form-label text-white">Selecciona CURP</label>
                        <input class="form-control" name="curp" type="file" id="curp" required>
                    </div>
                    <div class="mb-3">
                        <label for="Acta" class="form-label text-white">Selecciona Acta Nacimeinto</label>
                        <input class="form-control" name="Acta" type="file" id="Acta" required>
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        <label for="domicilio" class="form-label text-white">Selecciona comprobante domicilio</label>
                        <input class="form-control" name="domicilio" type="file" id="domicilio" required>
                    </div>
                    <div class="centrar ">
                        <button type="submit" class="btn btn-primary" id="registrodocper">Registrar</button>
                    </div>
                </form>
            </div>
        </div>
    ...
    <script src="../js/datosPersonal.js"></script>
